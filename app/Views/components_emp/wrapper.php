...
<nav id="sidebar" class="sidebar">
  ...
  <ul class="list-unstyled">
    ...
    if (isset($Q_Pos_ID) && $Q_Pos_ID >= 4) { ?>
      <!-- Admin -->
      <li>
        <a href="<?php echo base_url('manage-allUsers'); ?>" id="wrapper-8" class="listboxpf ps-5 fs16">จัดการผู้ใช้</a>
      </li>
    <?php } ?>
    <li>
    ...
    <li>
      <a href="<?php echo base_url('create-pdf'); ?>" id="wrapper-5" class="listboxpf ps-5 fs16" target="_blank">พิมพ์เอกสาร</a>
    </li>
    <li>
      <a href="<?php echo base_url('manage-van'); ?>" id="wrapper-6" class="listboxpf ps-5 fs16">จัดการข้อมูลรถ</a>
    </li>
    <li>
      <a href="<?php echo base_url('manage-complaint'); ?>" id="wrapper-7" class="listboxpf ps-5 fs16">การรายงานปัญหา</a>
    </li>
    <?php if (isset($Q_Pos_ID) && $Q_Pos_ID >= 4) { ?>
      <!-- Admin -->
      <li>
        <a href="<?php echo base_url('check-credit'); ?>" id="wrapper-9" class="listboxpf ps-5 fs16">ข้อความ SMS</a>
      </li>
    <?php } ?>
